...
<html>
  ...
  <body >
	...
	<form name="form1" class="form-horizontal" action="${pageContext.request.contextPath}/admin/qiyemanager.do"  id="form1" method="post"  >
                  <input type="hidden" name="actiontype" value="modifyPw"/>
				  <input type="hidden"  name="id" value="${qiye.id}"/>
				  <input type="hidden"  name="forwardurl"  value="/qiye/accountinfo.jsp?seedid=101"/>
				  <input type="hidden"  name="errorpageurl"  value="/qiye/modifypw.jsp?seedid=101"/>
