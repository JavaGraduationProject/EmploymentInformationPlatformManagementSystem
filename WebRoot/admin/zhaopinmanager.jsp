...
<html>
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/zhaopinmanager.do?actiontype=load&forwardurl=/admin/zhaopinadd.jsp">新建招聘</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
				...
				<tbody>
					<tr>
						<td>职位名称 <input name="title" value="${title}"
							...
							type="hidden" name="forwardurl" value="/admin/zhaopinmanager.jsp" />
		...
		<tbody>
			...
			<tr>
				...
				<td><a class="orange-href"
					href="${pageContext.request.contextPath}/admin/zhaopinmanager.do?actiontype=load&id=<%=temzhaopin.getId()%>&forwardurl=/admin/zhaopinadd.jsp">修改</a>
					<a class="orange-href"
					href="${pageContext.request.contextPath}/admin/zhaopindetails.jsp?id=<%=temzhaopin.getId()%>">查看</a>
				</td>
			</tr>
			<%}}%>
		</tbody>
